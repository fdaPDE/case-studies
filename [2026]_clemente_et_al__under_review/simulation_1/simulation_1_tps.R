...
output_dir = paste0("simulation_1/", r_param, "/", n_locs, "/", sim, "/") 
...
test_locs = as.matrix(readMM(paste0(data_dir, "test_locs.mtx")))
test_obs = as.matrix(readMM(paste0(data_dir,"test_obs.mtx")))
